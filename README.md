...
| AI の能力 | 渡すもの | 補足 |
|---|---|---|
| zip を展開できる | **`666.zip`** ＋ `INDEX.md` を地図に個別ファイル | 分割のまま読めて最も精度が高い |
| zip を読めない | **`666_all.md`**（全部載せ） | 先頭に圧縮版の正典＋目次を配置済みで読み落ちにくい |
...
```bash
bash tools/build.sh            # INDEX.md / 666_all.md / DIGEST.md / 666.zip をまとめて再生成
