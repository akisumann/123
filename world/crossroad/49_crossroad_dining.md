...
- **時間帯で生きる店が変わる**(`world/70_calendar_and_climate.md`)。朝〜昼は茶屋・井戸端(土香る庵・水音茶房・ひだまり縁側・芽吹き棚・旅籠前茶屋・砥草)、**昼の一刻だけ南区の飯屋《鎚音》が猛烈に混む**、夕方は仕事終わりの酒場(赤釘亭・帰還者の杯・折れ角)、宵〜深夜は西区の酒場(夜鴉の止まり木・月裏亭)が本番。今が何刻かで、開いて賑わっている店を選ぶ。
...
**南区**・工房街の外れにある茶屋(「とくさ」)。炉の熱にやられた者が、冷やした麦湯と塩気のある漬物で一息つく。品数は少なく、甘い物はほとんど置いていない。

**店名の砥草は、木地や角を磨くのに使う草である。** 店先に束ねて干してあり、職人は買って帰ることもできる。**南区で唯一、腰を下ろして黙っていられる場所**なので、話をしに来る店ではない。

- **常連・顔ぶれ**：空鎧の銀雪(すり足で通う。**鎧のまま黙って座っていられる数少ない店**。`characters/npcs/54_ginsetsu.md`)、折れずのサン(焼き入れで火に当たりすぎた日に。`characters/npcs/69_san_hidewell.md`)、防具のイチカ(革を裁いた後の目を休めに。`characters/npcs/67_ichika_hidewell.md`)、仕掛屋のセレナ(一人になりたい日。`characters/npcs/26_serena_gearford.md`)、鍛冶頭のガルム(炉を落とした後。`characters/npcs/06_galm_forgelight.md`)、受け流しの蒼龍(`characters/npcs/32_souryuu.md`)、蠍尾のザラ(黒針会。**静かで、誰も話しかけてこない**という理由だけで使う。`characters/npcs/15_zara.md`)、《東区第四学校》の織部(南区へ用がある日に、隅で一杯だけ。`characters/npcs/66_oribe.md`)。**話をしに来る店ではない。**

## 飯屋

**昼に腹を満たすためだけの店。** 酒は置くが、飲みに来る場所ではない。品数が少なく、出るのが速く、量がある。

### 飯屋《鎚音》

**南区**・工房街の真ん中にある一膳飯屋(「つちおと」)。**昼の一刻だけ猛烈に混む。** 職人は工房を長くは空けられないので、座って食って出るまでが速い。麦飯、汁、煮付け、漬物。献立は日によって一つか二つしか変わらない。

**混むのは職人だけが理由ではない。** 発注や修理で南区へ来た者は、話が昼にかかると帰る場所が無い。**相席が当たり前で、隣が誰になるかは選べない**——衛兵と盗人が同じ卓で麦飯を食っていることがある。

- **常連・顔ぶれ**：鍛冶頭のガルム(`characters/npcs/06_galm_forgelight.md`)、ヘンテコ薬品のミルカ(`characters/npcs/13_mika.md`)、仕掛屋のセレナ(`characters/npcs/26_serena_gearford.md`)、伝説錬金の琥珀と巨大腕の白金(廃研究施設から昼だけ降りてくる。`characters/npcs/52_kohaku.md`、`characters/npcs/53_hakkin.md`)、受け流しの蒼龍(量が出るので。`characters/npcs/32_souryuu.md`)、ハイドウェル三姉妹(**店を空けられないので交代で一人ずつ来る**。`characters/npcs/67_ichika_hidewell.md`、`characters/npcs/68_nino_hidewell.md`、`characters/npcs/69_san_hidewell.md`)、護衛双盾のマモリ(イチカに鎧の採寸を頼んだ帰り。`characters/npcs/41_mamori.md`)、武者修行中の紅葉(同じく鎧の直しで。`characters/npcs/43_momiji.md`)、狩人の天雷(ニノに大弓の調整を頼んだ帰り。`characters/npcs/37_tenrai.md`)、斥候のツバキ(サンの小物を仕入れに。`characters/npcs/36_tsubaki.md`)、情報屋のリネット(同じく斥候道具の調達で。`characters/npcs/10_linette.md`)、コソ泥の小夜(**同じ卓に衛兵が座っていても平気な顔で食う**。`characters/npcs/38_sayo.md`)、衛兵隊のエイダ(隊の装備の発注で。`characters/npcs/04_ada_lockwell.md`)、カーウェン商会のリド(仕入れの足で。`characters/npcs/65_rido_carwen.md`)。**相席が当たり前で、隣が誰になるかは選べない。**
