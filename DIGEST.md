...
| `characters/npcs/60_shiromine.md` | クロスロード大病院の院長・白峰。八尺様の妖怪でMP:Sの院内最高の回復術師。大型の治癒砲(ヒールビーム/ヒールキャノン)で重症・集団治療を担う最後の砦。運営は苦手。 | 3,843 |
...
合計 **179 ファイル / 1,808,739 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
