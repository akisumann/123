...
| `world/29_world_seeds.md` | クロスロードの外、世界のどこかにあるものの種(ダンジョンコアを制御下に置いて人材を育てるダンジョン学園＋王国が管理していたコア七本、大陸上を年中巡回する空中要塞、超大型多脚ゴーレムが運ぶ街、王国最強の特務部隊、黄泉に繋がるとされる奈落の渓谷、召喚できず状況でしか誘発できない概念存在四体《血宴の女王》《無貌の観測者》《遊戯の支配者》《静寂の庭園主》)。75の世界規模版で、各項目は「決まっていること／既存設定との接続／仮置き・未決定」に分けてある。引き出しであってToDoではなく、結末は決めずGMの裁量に委ねる。 | 8,938 |
...
合計 **180 ファイル / 1,831,651 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
