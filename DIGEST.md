...
| `towns/rockwell/02_rockwell_town.md` | ロックウェルの町の作り。区画ではなく坑口から街道へ下る一本の坂で、上から坑口・選鉱場と精錬所・鍛冶場と住まい・宿と市・荷置き場。炉は止まらず煙が細ければ何かあった合図。ギルドは職員5〜6人の小さな支部。 | 1,330 |
...
合計 **177 ファイル / 1,754,006 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
