...
| `world/crossroad/80_stampede.md` | 危険地域の群れが一斉に街へ向かってくる都市防衛戦。城壁があるので籠城すれば都市は落ちないが、壁の内側から戦っても群れは減らず、被害は壁の外(畑・街道・農村・隊商)へ積み上がり続ける。籠城は領主の三信条を三つとも同時に止めるので、打って出るしかないという形が本体。数字は湧き場をそのまま使う(敵戦況値据え置き、6人一隊は保つだけ、回復役必須)。赤牙＝数の案件、灰岩＝飛ぶので壁が効かない、骨鳴り＝街の手に負えず双槌と王都待ち。予兆は依頼票の形で五段階、危険地域が空になるのが決定打。 | 6,594 |
...
合計 **179 ファイル / 1,774,564 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
