...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `CLAUDE.md` | 123 — ファンタジーTRPG世界構築リポジトリ | 9,998 |
| `PROGRESS.md` | PROGRESS | 59,467 |
| `README.md` | 123 — ファンタジーTRPG世界「クロスロード」設定リポジトリ | 1,226 |
| `START_HERE.md` | はじめに読む（START HERE）— AI 向け入口 | 5,531 |
...
合計 **149 ファイル / 568,695 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
