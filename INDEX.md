...
| `towns/rockwell/13_transport.md` | 作成中。荷方の長(名前未定・男性・Lv45)。大地の竜人で、デカい地竜に変身して積荷を引っ張る。金属をクロスロードへ出し、坑木・炭にする木・食料・道具を入れる。 | 558 |
...
合計 **181 ファイル / 1,748,756 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
