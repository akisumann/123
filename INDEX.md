...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `123_city.md` | 123_city — クロスロード編(単一ファイル版) | 681,690 |
...
| `characters/pc_misaka.md` | 主人公・御坂美琴(Lv50)。北区拠点のBランク冒険者・雷使い。魔力量で押す撃ち手だが足が止まっている。 | 911 |
...
合計 **167 ファイル / 1,560,657 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
