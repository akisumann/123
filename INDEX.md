...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `123_city.md` | 123_city — クロスロード編(単一ファイル版) | 557,268 |
...
| `world/crossroad/34_crossroad_justice.md` | 捕まえた後の裁きと刑罰。牢は魔法で脱走対策されている。収監・賠償・労役・追放を使い分け、死刑だけは都市が持たない。 | 4,145 |
...
合計 **154 ファイル / 1,229,638 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
