...
| `towns/rockwell/04_rockwell_mogura_tunnel.md` | ロックウェル固有のダンジョン・大モグラ坑道(全25階、浅層Lv20〜30/中層35〜45/深層50〜60)。入口は人の掘った四角い坑道で奥は獣の丸い穴。オオミミズ・オオモグラ・大アリ・出歯ネズミの四種が別々のやり方で掘り続けるので地図が保たない。中枢のマグニファイコアに近いほど個体は大きいが、栄養価は坑道全体に及び入口の一匹でも桁違い。 | 4,064 |
...
合計 **172 ファイル / 1,713,564 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
