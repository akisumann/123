...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `123_city.md` | 123_city — クロスロード編(単一ファイル版) | 584,129 |
| `CHARACTERS.md` | 主要NPC62人の要点を1枚に集めた名簿(レベル・拠点区画・得意/不得意・看板スキル・口調・行きつけ)。自動生成。 | 11,707 |
| `CLAUDE.md` | 123 — ファンタジーTRPG世界構築リポジトリ | 9,810 |
| `PROGRESS.md` | PROGRESS | 128,771 |
...
| `world/crossroad/76_artifacts.md` | 街にある一点物の遺物と作り方。遺物は所有者へ追加スキルを一つ付与する。十字剣クロスブレード(領主家継承・S級の膂力・超重量直剣Lv8)、大地龍の杖(大神殿・MP:S・回復魔法Lv7)、パペッターコア(下水道に放置・DEX:S・傀儡操糸Lv8)。 | 10,182 |
...
| `characters/npcs/32_souryuu.md` | 統制パーティー前衛・蒼龍。水精霊、受け流しの守り手。当主・睡蓮の専属護衛で、水城の妹。 | 2,693 |
...
合計 **157 ファイル / 1,308,417 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
