...
| `rules/12_pc_creation.md` | 主人公をダイスで作る手順。レベル1d6(25〜50)→得意苦手2d7→残りを埋める→職業を見繕う、を一巡として三回回し、三案から一つ選ぶ。 | 2,255 |
...
| `characters/npcs/66_oribe.md` | 《東区第四学校》の教師・織部。全身を白い霊布で巻いて壁と天井を這う、街の面白名物。昔どこかの小国で退魔師をしていた。布を操る一本だけで積み上げた対策が、そのまま生徒への教材になっている。 | 10,593 |
...
合計 **166 ファイル / 1,553,509 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
