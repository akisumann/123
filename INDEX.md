...
| `rules/12_pc_creation.md` | 主人公をダイスで作る手順。レベルは1d6で25〜50、得意分野と苦手分野は2d7、同じ目なら平たいステータス。 | 2,071 |
...
合計 **166 ファイル / 1,552,784 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
