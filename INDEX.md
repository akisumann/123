...
| `world/crossroad/75_scenario_seeds.md` | 観覧モードで使える伏線・展開の種のネタ帳(紅葉の星喰いリベンジ、ツバキの決断、ボルガンの偽装露見、ララ・カーラの旅立ち計画など)。結末は決めずGMの裁量に委ねる。 | 2,596 |
...
合計 **149 ファイル / 530,831 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
