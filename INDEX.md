...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 鉱山町ロックウェル(街規模・人口6,000)の総合設定。クロスロードから2〜3日、街道は2本(金属を出す灰岩街道と、坑木・炭にする木が入る南東街道)。鉱山は領主家の物で運営は町、首長は現地上がりの町長。名ありNPCは10人枠。 | 1,877 |
...
| `towns/rockwell/13_transport.md` | 作成中。荷方の長(名前未定・男性・Lv45)。臥竜谷の竜盟に属する地竜人で、デカい地竜に変身して積荷を引っ張る。人間状態でもかなりの体躯、竜状態は家一軒ほど。 | 778 |
...
合計 **181 ファイル / 1,748,989 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
