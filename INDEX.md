...
| `rules/12_pc_creation.md` | 観覧モードからキャラを動かすモードへ移る時に、主人公候補を三タイプ自動生成して選ばせる手順。レベル1d6・得意苦手2d7・職は大雑把に。 | 2,393 |
...
合計 **166 ファイル / 1,555,751 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
