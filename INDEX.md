...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `world/crossroad/11_crossroad_city.md` | 主舞台クロスロードの総合設定。人口・統治・街の転機・街道・危険地域4/ダンジョン3。 | 18,085 |
...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 鉱山町ロックウェル(街規模・人口6,000)の総合設定。クロスロードから2〜3日、街道は2本(金属を出す灰岩街道と、坑木・炭にする木が入る南東街道)。鉱山は領主家の物で運営は町、首長は現地上がりの町長。名ありNPCは10人枠。 | 1,871 |
| `towns/rockwell/02_rockwell_town.md` | ロックウェルの町の作り。坑口から街道へ下る一本の坂に沿って伸びる。飯・酒・宿は相場のまま。 | 411 |
| `towns/rockwell/03_rockwell_danger_zones.md` | ロックウェル固有の危険地域。捨石丘陵(Lv10〜20・屑石の人工丘・駆け出しの出発点)と雷鳴山地(Lv25〜35・金属を持つと狙われる)。 | 966 |
| `towns/rockwell/04_rockwell_mogura_tunnel.md` | ロックウェル固有のダンジョン・大モグラ坑道(全25階・Lv20〜60)。四種が掘り続けるので地図が保たず、中枢のマグニファイコアで奥ほど個体が大きくなる。肉は町の食料庫。 | 1,414 |
| `towns/rockwell/05_rockwell_facilities.md` | ロックウェルの組織と施設。鉱山はクロスロード領主家の物で、運営は町が任されている。長は現地上がりの町長(ガレス)。組織は代官所(町の役所)・鉱山方・荷方・神殿の四つ。 | 1,040 |
| `towns/rockwell/06_gareth_dorn.md` | ロックウェル町長ガレス・ドルン(Lv47・ドワーフ)。元鉱夫で坑から上がった現地上がりの首長。三基の浮遊コーンビットを操る、現場へ降りたがる管理職。差配は短く岩の話は長い。 | 1,434 |
| `towns/rockwell/07_rockwell_guild.md` | 冒険者ギルドのロックウェル支部。職員5〜6人・登録200人で分布は壺型、A級はいない。深層の依頼は出さずクロスロードへ送る。 | 851 |
| `towns/rockwell/08_rockwell_quest_board.md` | ロックウェル支部の定番依頼の掲示例。捨石丘陵(F〜E)・雷鳴山地(D〜C)・大モグラ坑道の浅層と中層(D〜B)。深層は掲示しない。 | 1,643 |
| `towns/rockwell/09_rockwell_works.md` | ロックウェルの採掘場と精錬施設。普通の金属が全種類出る(魔法金属は出ない)。稼働坑口12本・炉14基・鉱業2,000人。金属精錬のメイン中のメインは溶岩系魔人達で、炉は第三階位の魔法で焚く。金属はクロスロードへ一括納入。木炭は町で焼き、原料の木は南東街道から入る。 | 1,531 |
| `towns/rockwell/10_shuren.md` | 精錬枠の溶岩魔人・朱蓮(Lv49・女性)、通り名「溶岩風呂の朱蓮」。炉に棲みついており本人にとっては風呂。ドパガキで出力が上がり、風呂（高炉）好きLv7がちょうどいい温度へ収める。日常とよく接する人物が未設定。 | 2,603 |
| `towns/rockwell/11_sansho.md` | 大衆酒場《大槌亭》の女将・山椒(Lv40・虎獣人・女性・中年)、通り名「大鍋の山椒」。姉御肌で、代々この店をやっている家。クソデカい中華鍋を大火力で振り、栄養供給が鉱夫の力になっている。 | 1,391 |
| `towns/rockwell/12_party.md` | 作成中。ロックウェル唯一の冒険者一党(チーム名未定)。B帯4人で町の最高戦力だが深層には届かない。半分固定のなんでも屋。1人目は「煙草弾のニコレット」(Lv47・人間・ヤニカスのガトリング使い。タバコ火空気精査Lv9)。残り3人は未設定。 | 1,607 |
| `towns/rockwell/13_iwato.md` | ロックウェル荷方の長・岩戸(Lv45・地竜人・男性・38歳)、通り名「一頭立ての岩戸」。臥竜谷の竜盟出身で、家一軒ほどの地竜に変身して専用の荷馬車を引き、一度に20〜30トンを運ぶ。気のいいあんちゃん。 | 1,343 |
...
合計 **181 ファイル / 1,749,584 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
