...
| `towns/rockwell/09_rockwell_works.md` | ロックウェルの採掘場と精錬施設。普通の金属が全種類出る(魔法金属は出ない)。稼働坑口12本・炉14基・鉱業2,000人。炉は第三階位の魔法で焚き、金属はクロスロードへ一括納入。木炭は町で焼き、原料の木は南東街道から入る。 | 1,509 |
| `towns/rockwell/10_shuren.md` | 精錬枠の溶岩魔人・朱蓮(Lv49・女性)、通り名「溶岩風呂の朱蓮」。炉に棲みついており本人にとっては風呂。ドパガキで出力が上がり、風呂（高炉）好きLv7がちょうどいい温度へ収める。日常とよく接する人物が未設定。 | 2,558 |
...
合計 **180 ファイル / 1,748,098 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
