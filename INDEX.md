...
| `world/crossroad/77_north_district_trading_houses.md` | 北区大通りに向かい合う二大商会の建物。倉庫を抱える石造りのガルド大商会《金蔵》と、荷が留まらない四つ口のカーウェン商会《空店》、間の通り「商会前」。 | 4,098 |
...
合計 **160 ファイル / 1,409,198 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
