...
| `characters/npcs/16_gideon.md` | 黒針会会主ギデオン。組織の最終裁定を担う老練な会主。 | 4,159 |
...
| `characters/npcs/29_vorgan_gard.md` | 北区商業組合長ボルガン・ガルド(Lv48・偽装Lv18)。強欲な大商会会頭。 | 4,910 |
...
合計 **167 ファイル / 1,624,813 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
