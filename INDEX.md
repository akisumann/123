...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 灰岩峡谷を越えた先にある鉱山町ロックウェル(街規模・人口6,000)の総合設定。自前の鉱脈で普通に栄えている。街道・峡谷・忘れられた鉱山はクロスロードと共有で、町固有の危険地域は町の先にある。クロスロードとファイルを分ける線引きもここ。 | 2,673 |
| `towns/rockwell/02_rockwell_town.md` | ロックウェルの町の作り。区画ではなく坑口から街道へ下る一本の坂で、上から坑口・選鉱場と精錬所・鍛冶場と住まい・宿と市・荷置き場。坂なので荷方の仕事は上りに集まる。炉は止まらず煙が細ければ何かあった合図。ギルドは職員5〜6人の小さな支部。 | 1,142 |
...
| `towns/rockwell/04_rockwell_mogura_tunnel.md` | ロックウェル固有のダンジョン・大モグラ坑道(全25階、浅層Lv20〜30/中層35〜45/深層50〜60)。入口は人の掘った四角い坑道で奥は獣の丸い穴。四種が別々のやり方で掘り続けるので地図が保たない。中枢のマグニファイコアで個体が大きく肉も濃い。ダンジョン産というだけで栄養価が桁違いで、町は「ダンジョン産でないと物足りない」。奥のものは高級品。 | 4,123 |
| `towns/rockwell/05_rockwell_facilities.md` | 鉱山はクロスロード領主家(クラリス)の持ち物で、町は代官が回している。組織は代官所・鉱山方・荷方・神殿の四つ、施設は治療院・水場・墓地。魔法治療は町にほとんど無く骨折は添え木と時間で治す。コロッセオ・カジノ・劇場・娼館・浄化院・商業組合・黒針会に相当する物は無い。 | 2,564 |
...
| `towns/rockwell/07_rockwell_guild.md` | 冒険者ギルドのロックウェル支部。街規模なので出張受付所ではなく支部。職員は5〜6人、登録冒険者およそ200人。分布は壺型でD帯(約60)が一番厚く、F帯は細くB帯は増えつつある。A帯にあたる大モグラ坑道の深層(Lv50〜60)の依頼は出さずクロスロード支部へ送る。買い取りの本体は魔物素材とダンジョン産の肉。 | 3,074 |
...
合計 **175 ファイル / 1,738,295 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
