...
| `rules/12_pc_creation.md` | 主人公をダイスで作る手順。レベル1d6(25〜50)→得意苦手2d7→残りを埋める→職業を見繕う、を一巡として三回回し、三案から一つ選ぶ。 | 2,238 |
...
合計 **166 ファイル / 1,553,691 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
