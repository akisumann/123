...
| `world/crossroad/31_crossroad_security_forces.md` | 衛兵隊・騎士団・ギルド・浄化院の役割分担と衛兵の階級別レベル目安。 | 4,251 |
...
合計 **153 ファイル / 1,212,986 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
