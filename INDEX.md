...
| `towns/rockwell/09_rockwell_works.md` | ロックウェルの採掘場と精錬施設。普通の金属が全種類出る(魔法金属は出ない)。稼働坑口12本・炉14基・鉱業2,000人。金属精錬は溶岩系魔人達が主流で、炉は第三階位の魔法で焚く。金属はクロスロードへ一括納入。木炭は町で焼き、原料の木は南東街道から入る。 | 1,525 |
...
合計 **180 ファイル / 1,748,159 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
