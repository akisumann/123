...
| `world/crossroad/76_artifacts.md` | 街にある一点物の遺物と、遺物を足す時の作り方。十字剣クロスブレード(領主家継承・ATK:S)、大地龍の杖(大神殿・MP:S)。 | 2,709 |
...
合計 **155 ファイル / 1,238,376 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
