...
| `characters/npcs/33_suiren.md` | 統制パーティー中衛・睡蓮。水精霊、戦場制御役。アクア・フロウの貴族家門の当主で、四人はこの家の一行。 | 2,544 |
...
合計 **157 ファイル / 1,319,440 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
