...
| `world/crossroad/34_crossroad_justice.md` | 捕まえた後の裁きと刑罰。牢は浄化院の結界で固めてあり脱走はまず不可能。収監・賠償・労役・追放を使い分け、死刑だけは都市が持たない。 | 5,052 |
...
合計 **154 ファイル / 1,230,953 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
