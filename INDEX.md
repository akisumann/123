...
| `world/crossroad/63_bone_toll_moor.md` | 危険地域④骨鳴り墓原(Lv55〜65)。アンデッドを集める古戦場跡の墓原。 | 5,946 |
| `world/crossroad/64_danger_zone_quest_board.md` | 4つの危険地域を舞台にした、ギルド定番依頼の掲示例。 | 4,316 |
...
合計 **160 ファイル / 1,446,092 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
