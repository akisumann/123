...
| `world/crossroad/75_scenario_seeds.md` | 観覧モードで使える伏線・展開の種のネタ帳(紅葉の星喰いリベンジ、ツバキの決断、ララ・カーラの教え乞い、エルシアの二重生活ニアミス、琥珀の隠しきれなさ、下水道ニート達への細い導線、マモリのファンクラブ、九重・クサビの回復役探し、エリアスの取材癖、レオンのダメと鋭さの落差)。結末は決めずGMの裁量に委ねる。 | 6,906 |
...
合計 **149 ファイル / 538,159 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
