...
| `world/27_ginsetsu_soukaku_mamori.md` | マモリが銀雪を着ただけの姿・銀雪装殻(Lv65)。それだけで十字剣クロスブレードが振れてしまう。 | 3,934 |
...
| `world/crossroad/76_artifacts.md` | 街にある一点物の遺物と作り方。遺物は所有者へ追加スキルを一つ付与する。十字剣クロスブレード(領主家継承・超重量直剣Lv8)、大地龍の杖(大神殿・MP:S・回復魔法Lv7)。 | 5,573 |
...
合計 **156 ファイル / 1,261,841 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
