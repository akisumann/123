...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 鉱山町ロックウェル(街規模・人口6,000)の総合設定。灰岩街道を南へ下りきった所にある行き止まりの町で、遠いのは危険ではなく距離。未設定の一覧もここ。 | 1,064 |
...
合計 **177 ファイル / 1,740,742 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
