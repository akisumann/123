...
| `world/nations/25_aqua_flow_union.md` | 五大国・アクア・フロウ連合(南西海洋地帯、人魚が主要種族)。 | 6,862 |
...
| `characters/npcs/31_mizushiro.md` | 統制パーティー隊長・水城。水精霊。当主・睡蓮に仕える執事兼戦術教官で、蒼龍の姉。 | 4,211 |
...
合計 **157 ファイル / 1,311,498 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
