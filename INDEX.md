...
| `towns/rockwell/04_rockwell_mogura_tunnel.md` | ロックウェル固有のダンジョン・大モグラ坑道(全25階、Lv30〜55)。入口は人の掘った四角い坑道で、奥は獣の掘った丸い穴。土ごと食うオオミミズ・それを追うオオモグラ・隙間に巣を作る大アリの三者が掘り続けているので形が変わり続け、地図が保たない。中枢のマグニファイコアに近いほど個体が大きく、穴の太さで先に何がいるか分かる。 | 2,656 |
...
合計 **172 ファイル / 1,709,373 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
