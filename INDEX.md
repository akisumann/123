...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `123_city.md` | 123_city — クロスロード編(単一ファイル版) | 592,567 |
| `CHARACTERS.md` | 主要NPC62人の要点を1枚に集めた名簿(レベル・拠点区画・得意/不得意・看板スキル・口調・行きつけ)。自動生成。 | 12,135 |
| `CLAUDE.md` | 123 — ファンタジーTRPG世界構築リポジトリ | 9,810 |
| `PROGRESS.md` | PROGRESS | 138,043 |
...
| `characters/npcs/64_norai.md` | 西区の街娼・野雷。雷獣の妖怪で街唯一のSPD:S。店に属さず金勘定も分からない野良猫。 | 3,193 |

---

合計 **158 ファイル / 1,333,890 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
