...
| `towns/rockwell/07_rockwell_guild.md` | 冒険者ギルドのロックウェル支部。職員5〜6人・登録200人で分布は壺型、A級はいない。深層の依頼は出さずクロスロードへ送る。 | 862 |
...
合計 **180 ファイル / 1,747,978 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
