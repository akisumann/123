...
| `towns/rockwell/11_sansho.md` | 作成中。大衆酒場《大槌亭》の女将・山椒(虎獣人・女性・中年)。姉御肌。代々この店をやっている家で、街で一番大きい大衆酒場。中華料理店のような雰囲気で、クソデカい中華鍋を大火力で振る。レベル・口調は未設定。 | 730 |
...
合計 **179 ファイル / 1,745,698 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
