...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 鉱山町ロックウェル(街規模・人口6,000)の総合設定。クロスロードから2〜3日、街道は2本(金属を出す灰岩街道と、坑木・炭が入る南東街道)。鉱山は領主家の物で運営は町、首長は現地上がりの町長。名ありNPCは10人枠。 | 1,748 |
...
| `towns/rockwell/10_shuren.md` | 作成中。精錬枠の溶岩魔人・朱蓮(Lv49・女性)。炉に棲みついており、本人にとっては風呂。最上位スキルが「風呂（高炉）好き」Lv7。外見・口調・来歴は未設定。 | 1,823 |
...
合計 **178 ファイル / 1,744,176 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
