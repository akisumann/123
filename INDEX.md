...
| `towns/rockwell/04_rockwell_mogura_tunnel.md` | ロックウェル固有のダンジョン・大モグラ坑道(全25階、浅層Lv20〜30/中層35〜45/深層50〜60)。入口は人の掘った四角い坑道で奥は獣の丸い穴。オオミミズ・オオモグラ・大アリが掘り、出歯ネズミが齧るので地図が保たない。中枢のマグニファイコアに近いほど個体が大きく中身も濃い。「奥の肉」は鉱夫の力の源で、町の依頼の柱。 | 3,805 |
...
合計 **172 ファイル / 1,712,519 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
