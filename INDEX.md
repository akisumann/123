...
| `towns/rockwell/10_shuren.md` | 作成中。精錬枠の溶岩魔人・朱蓮(Lv48・女性)。炉に棲みついており、本人にとっては風呂。確定は種族・性別・年齢帯と生成した数値のみで、外見・口調・来歴は未設定。 | 791 |
...
合計 **178 ファイル / 1,743,038 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
