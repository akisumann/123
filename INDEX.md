...
| `towns/rockwell/06_gareth_dorn.md` | ロックウェル鉱山方の長ガレス・ドルン(Lv47・ドワーフ)。三基の浮遊するコーンビット(大楯並の円錐ドリル)を操り、盾にも攻めにも使う。三基を合わせるとトリコーンビットになり採掘性能を最大限に発揮する。スキルは戦闘採掘系3つ(コーンビット操作・トリコーンビット・岩読み)＋統治寄り2つ(坑内差配・裁定)で合計24。外見・来歴・性格・口調・日常はまだ決めていない。 | 1,228 |
...
合計 **174 ファイル / 1,727,009 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
