...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `123_city.md` | 123_city — クロスロード編(単一ファイル版) | 549,513 |
| `CHARACTERS.md` | 主要NPC60人の要点を1枚に集めた名簿(レベル・拠点区画・得意/不得意・看板スキル・口調・行きつけ)。自動生成。 | 11,383 |
| `CLAUDE.md` | 123 — ファンタジーTRPG世界構築リポジトリ | 9,479 |
| `PROGRESS.md` | PROGRESS | 99,209 |
...
合計 **153 ファイル / 1,209,655 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
