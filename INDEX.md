...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 鉱山町ロックウェル(街規模・人口6,000)の総合設定。クロスロードから2〜3日、街道は2本(金属を出す灰岩街道と、坑木・炭にする木が入る南東街道)。鉱山は領主家の物で運営は町、首長は現地上がりの町長。名ありNPCは10人枠。 | 1,864 |
...
| `towns/rockwell/05_rockwell_facilities.md` | ロックウェルの組織と施設。鉱山はクロスロード領主家の物で、運営は町が任されている。長は現地上がりの町長(ガレス)。組織は代官所(町の役所)・鉱山方・荷方・神殿の四つ。 | 1,004 |
...
| `towns/rockwell/13_transport.md` | 作成中。荷方の長(名前未定・男性・Lv45)。大地の竜人で、デカい地竜に変身して積荷を引っ張る。金属をクロスロードへ出し、坑木・炭にする木・食料・道具を入れる。 | 523 |
...
合計 **181 ファイル / 1,748,721 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
