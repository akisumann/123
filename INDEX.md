...
| `towns/rockwell/13_transport.md` | 作成中。荷方の長(名前未定)。大地の竜人で、デカい地竜に変身して大規模輸送を担う。金属をクロスロードへ出し、坑木・炭にする木・食料・道具を入れる。 | 413 |
...
合計 **181 ファイル / 1,748,611 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
