...
| `world/09_dungeon_generation.md` | 自然発生・遺構・人工など、ダンジョンを生成するルール。どのダンジョンにも魔物と資源を補充するコアがあり、壊すと止まるので収支の面で壊さない。 | 2,383 |
...
合計 **156 ファイル / 1,273,704 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
