...
| `towns/rockwell/13_transport.md` | 作成中。荷方の長(名前未定・男性・Lv45)。臥竜谷の竜盟に属する地竜人で、デカい地竜に変身して積荷を引っ張る。人間状態でもかなりの体躯、竜状態は家一軒ほど。 | 668 |
...
合計 **181 ファイル / 1,748,879 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
