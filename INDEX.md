...
| ファイル | 内容(TL;DR) | 文字数 |
|---|---|---|
| `towns/rockwell/01_rockwell.md` | 灰岩峡谷を越えた先にある鉱山町ロックウェル(街規模・人口6,000)の総合設定。自前の鉱脈で普通に栄えている。街道・峡谷・忘れられた鉱山はクロスロードと共有で、町固有の危険地域は町の先にある。クロスロードとファイルを分ける線引きもここ。 | 2,593 |
...
| `towns/rockwell/05_rockwell_facilities.md` | 鉱山はクロスロード領主家(クラリス)の持ち物で、町は代官が回している。組織は代官所・鉱山方・荷方・神殿の四つ、施設は治療院・水場・墓地。魔法治療は町にほとんど無く骨折は添え木と時間で治す。コロッセオ・カジノ・劇場・娼館・浄化院・ギルド支部・黒針会に相当する物は無い。 | 2,520 |
...
合計 **174 ファイル / 1,733,302 文字**(空白除く)。1ファイルずつ読めば、一度に扱う量は常に小さく保てる。
